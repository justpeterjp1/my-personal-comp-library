...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-secondary border-b border-gray-200 dark:border-gray-800 shadow-sm backdrop-blur-lg bg-opacity-90 dark:bg-opacity-90">
