...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white dark:bg-[var(--secondary)] border-b border-gray-200 dark:border-gray-800 shadow-sm backdrop-blur-lg bg-opacity-90 dark:bg-opacity-90">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:block relative">
              <input
                ...
                className="w-64 px-4 py-2 pl-10 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
              <svg
            ...
            <a
              href="https://github.com/yourusername/your-library"
              target="_blank"
              rel="noopener noreferrer"
              className="hidden lg:flex items-center gap-2 px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition-colors"
            >
